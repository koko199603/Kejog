...
ulang:
// function change(){
echo color("purple","               CLAIM VOUCHER GOJEK   GOOOOO                  \n");
echo color("red","                By king @Wagir_Pinggiran                     \n");
...
echo "\n".color("green","ðŸ‘ŒðŸ± Ambil Voucer ");
        ...
        $code1 = requestedd('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"HARBORNASMART"}');
        $message = fetch_value12($code1,'"message":"','"');
        if(strpos($code1, 'Promo kamu sudah bisa dipakai')){
        echo "\n".colorss("green","ðŸ‘ðŸ™ Message: ".$message);
        }else{
...
echo "\n".color("green","ðŸ‘ŒðŸ± Ambil Voucer ");
        ...
        $code1 = requested('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"HARBOLNASMART"}');
